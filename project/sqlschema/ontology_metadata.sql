...
CREATE TABLE "Axiom" (
	...
	label TEXT, 
	"seeAlso" TEXT, 
	PRIMARY KEY ("annotatedProperty", "annotatedSource", "annotatedTarget", annotations, source, is_inferred, notes, url, has_axiom_label, is_a_defining_property_chain_axiom, is_a_defining_property_chain_axiom_where_second_argument_is_reflexive, created_by, date_retrieved, evidence, external_ontology, database_cross_reference, has_exact_synonym, has_synonym_type, comment, label, "seeAlso"), 
	FOREIGN KEY("annotatedProperty") REFERENCES "AnnotationProperty" (id), 
	FOREIGN KEY("annotatedSource") REFERENCES "NamedObject" (id)
);
...
CREATE TABLE "Agent_has_exact_synonym" (
	backref_id TEXT, 
	has_exact_synonym TEXT, 
...
CREATE TABLE "Agent_has_narrow_synonym" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_has_broad_synonym" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_has_related_synonym" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_alternative_term" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_ISA_alternative_term" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_IEDB_alternative_term" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_editor_preferred_term" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_OBO_foundry_unique_label" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_has_alternative_id" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_excluded_synonym" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_creation_date" (
	backref_id TEXT, 
	creation_date TEXT, 
...
CREATE TABLE "Agent_editor_note" (
	backref_id TEXT, 
	editor_note TEXT, 
...
CREATE TABLE "Agent_term_editor" (
	backref_id TEXT, 
	term_editor TEXT, 
...
CREATE TABLE "Agent_definition_source" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_term_tracker_item" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_narrowMatch" (
	backref_id TEXT, 
	"narrowMatch" TEXT, 
...
CREATE TABLE "Agent_database_cross_reference" (
	backref_id TEXT, 
	database_cross_reference TEXT, 
...
CREATE TABLE "Agent_has_obo_namespace" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_example_of_usage" (
	backref_id TEXT, 
...
CREATE TABLE "Agent_curator_note" (
	backref_id TEXT, 
	curator_note TEXT, 
...
CREATE TABLE "HomoSapiens_type" (
	backref_id TEXT, 
	type TEXT, 
	PRIMARY KEY (backref_id, type), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
);

CREATE TABLE "HomoSapiens_has_exact_synonym" (
	backref_id TEXT, 
	has_exact_synonym TEXT, 
	PRIMARY KEY (backref_id, has_exact_synonym), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_has_narrow_synonym" (
	backref_id TEXT, 
	has_narrow_synonym TEXT, 
	PRIMARY KEY (backref_id, has_narrow_synonym), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_has_broad_synonym" (
	backref_id TEXT, 
	has_broad_synonym TEXT, 
	PRIMARY KEY (backref_id, has_broad_synonym), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_has_related_synonym" (
	backref_id TEXT, 
	has_related_synonym TEXT, 
	PRIMARY KEY (backref_id, has_related_synonym), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_alternative_term" (
	backref_id TEXT, 
	alternative_term TEXT, 
	PRIMARY KEY (backref_id, alternative_term), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_ISA_alternative_term" (
	backref_id TEXT, 
	"ISA_alternative_term" TEXT, 
	PRIMARY KEY (backref_id, "ISA_alternative_term"), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_IEDB_alternative_term" (
	backref_id TEXT, 
	"IEDB_alternative_term" TEXT, 
	PRIMARY KEY (backref_id, "IEDB_alternative_term"), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_editor_preferred_term" (
	backref_id TEXT, 
	editor_preferred_term TEXT, 
	PRIMARY KEY (backref_id, editor_preferred_term), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_OBO_foundry_unique_label" (
	backref_id TEXT, 
	"OBO_foundry_unique_label" TEXT, 
	PRIMARY KEY (backref_id, "OBO_foundry_unique_label"), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_consider" (
	backref_id TEXT, 
	consider TEXT, 
	PRIMARY KEY (backref_id, consider), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_has_alternative_id" (
	backref_id TEXT, 
	has_alternative_id TEXT, 
	PRIMARY KEY (backref_id, has_alternative_id), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_excluded_synonym" (
	backref_id TEXT, 
	excluded_synonym TEXT, 
	PRIMARY KEY (backref_id, excluded_synonym), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_creation_date" (
	backref_id TEXT, 
	creation_date TEXT, 
	PRIMARY KEY (backref_id, creation_date), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_editor_note" (
	backref_id TEXT, 
	editor_note TEXT, 
	PRIMARY KEY (backref_id, editor_note), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_term_editor" (
	backref_id TEXT, 
	term_editor TEXT, 
	PRIMARY KEY (backref_id, term_editor), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_definition_source" (
	backref_id TEXT, 
	definition_source TEXT, 
	PRIMARY KEY (backref_id, definition_source), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_term_tracker_item" (
	backref_id TEXT, 
	term_tracker_item TEXT, 
	PRIMARY KEY (backref_id, term_tracker_item), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_broadMatch" (
	backref_id TEXT, 
	"broadMatch" TEXT, 
	PRIMARY KEY (backref_id, "broadMatch"), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_closeMatch" (
	backref_id TEXT, 
	"closeMatch" TEXT, 
	PRIMARY KEY (backref_id, "closeMatch"), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_exactMatch" (
	backref_id TEXT, 
	"exactMatch" TEXT, 
	PRIMARY KEY (backref_id, "exactMatch"), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_narrowMatch" (
	backref_id TEXT, 
	"narrowMatch" TEXT, 
	PRIMARY KEY (backref_id, "narrowMatch"), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_database_cross_reference" (
	backref_id TEXT, 
	database_cross_reference TEXT, 
	PRIMARY KEY (backref_id, database_cross_reference), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_has_obo_namespace" (
	backref_id TEXT, 
	has_obo_namespace TEXT, 
	PRIMARY KEY (backref_id, has_obo_namespace), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_conformsTo" (
	backref_id TEXT, 
	"conformsTo" TEXT, 
	PRIMARY KEY (backref_id, "conformsTo"), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_comment" (
	backref_id TEXT, 
	comment TEXT, 
	PRIMARY KEY (backref_id, comment), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_seeAlso" (
	backref_id TEXT, 
	"seeAlso" TEXT, 
	PRIMARY KEY (backref_id, "seeAlso"), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_example_of_usage" (
	backref_id TEXT, 
	example_of_usage TEXT, 
	PRIMARY KEY (backref_id, example_of_usage), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_curator_note" (
	backref_id TEXT, 
	curator_note TEXT, 
	PRIMARY KEY (backref_id, curator_note), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "HomoSapiens_definition" (
	backref_id TEXT, 
	definition TEXT, 
	PRIMARY KEY (backref_id, definition), 
	FOREIGN KEY(backref_id) REFERENCES "HomoSapiens" (id)
...
CREATE TABLE "Image_type" (
	...
	type TEXT, 
	PRIMARY KEY (backref_id, type), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
);

CREATE TABLE "Image_has_exact_synonym" (
	backref_id TEXT, 
	has_exact_synonym TEXT, 
	PRIMARY KEY (backref_id, has_exact_synonym), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_has_narrow_synonym" (
	backref_id TEXT, 
	has_narrow_synonym TEXT, 
	PRIMARY KEY (backref_id, has_narrow_synonym), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_has_broad_synonym" (
	backref_id TEXT, 
	has_broad_synonym TEXT, 
	PRIMARY KEY (backref_id, has_broad_synonym), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_has_related_synonym" (
	backref_id TEXT, 
	has_related_synonym TEXT, 
	PRIMARY KEY (backref_id, has_related_synonym), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_alternative_term" (
	backref_id TEXT, 
	alternative_term TEXT, 
	PRIMARY KEY (backref_id, alternative_term), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_ISA_alternative_term" (
	backref_id TEXT, 
	"ISA_alternative_term" TEXT, 
	PRIMARY KEY (backref_id, "ISA_alternative_term"), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_IEDB_alternative_term" (
	backref_id TEXT, 
	"IEDB_alternative_term" TEXT, 
	PRIMARY KEY (backref_id, "IEDB_alternative_term"), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_editor_preferred_term" (
	backref_id TEXT, 
	editor_preferred_term TEXT, 
	PRIMARY KEY (backref_id, editor_preferred_term), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_OBO_foundry_unique_label" (
	backref_id TEXT, 
	"OBO_foundry_unique_label" TEXT, 
	PRIMARY KEY (backref_id, "OBO_foundry_unique_label"), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_has_alternative_id" (
	backref_id TEXT, 
	has_alternative_id TEXT, 
	PRIMARY KEY (backref_id, has_alternative_id), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_excluded_synonym" (
	backref_id TEXT, 
	excluded_synonym TEXT, 
	PRIMARY KEY (backref_id, excluded_synonym), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_creation_date" (
	backref_id TEXT, 
	creation_date TEXT, 
	PRIMARY KEY (backref_id, creation_date), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_editor_note" (
	backref_id TEXT, 
	editor_note TEXT, 
	PRIMARY KEY (backref_id, editor_note), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_term_editor" (
	backref_id TEXT, 
	term_editor TEXT, 
	PRIMARY KEY (backref_id, term_editor), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_definition_source" (
	backref_id TEXT, 
	definition_source TEXT, 
	PRIMARY KEY (backref_id, definition_source), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_term_tracker_item" (
	backref_id TEXT, 
	term_tracker_item TEXT, 
	PRIMARY KEY (backref_id, term_tracker_item), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_narrowMatch" (
	backref_id TEXT, 
	"narrowMatch" TEXT, 
	PRIMARY KEY (backref_id, "narrowMatch"), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_database_cross_reference" (
	backref_id TEXT, 
	database_cross_reference TEXT, 
	PRIMARY KEY (backref_id, database_cross_reference), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_has_obo_namespace" (
	backref_id TEXT, 
	has_obo_namespace TEXT, 
	PRIMARY KEY (backref_id, has_obo_namespace), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_example_of_usage" (
	backref_id TEXT, 
	example_of_usage TEXT, 
	PRIMARY KEY (backref_id, example_of_usage), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
...
CREATE TABLE "Image_curator_note" (
	backref_id TEXT, 
	curator_note TEXT, 
	PRIMARY KEY (backref_id, curator_note), 
	FOREIGN KEY(backref_id) REFERENCES "Image" (id)
